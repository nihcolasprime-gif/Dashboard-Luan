...
const Sidebar = ({ activePage, setActivePage, isCompanyMode }) => {
  ...
  const companyMenu = [
    ...
    { id: 'financeiro', label: 'Fin. Corporate', icon: PieChart },
    { id: 'transacoes-empresa', label: 'Transações', icon: RefreshCw },
    { id: 'investimentos-empresa', label: 'Investimentos', icon: Target },
